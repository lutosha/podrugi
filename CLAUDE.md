...
Следующий шаг: **Фаза D** — подписки («Подруги»). Также в процессе: адаптация под мобильные — пользователь предупредила, что сервисом будут пользоваться в основном с телефона, это приоритет при любых доработках дизайна.
